...
var lol = addThenSubtract(bango3,bango4,bango5);
...
var lolol = multiplyThenDivide(bango3,bango4,bango5);
...
var myFullName = createFullName('Adam', ' Winfield-Smith');
...
var foodie = eatFood ('Adam','Winfield-Smith','Hot Dogs');
...
var centimeters = shoeSize(10) + ' cm';
...
*/
 ...
 var school = allCaps('I want to go home');
console.log (school);
...
var zio= oneCap('I want to sleep');
...
function throwParty (canDrink) {
 	if (canDrink >= 21) {
 		return console.log ('We gonna get lit')
 	} else {
 		return console.log ('I never like go anyway.);
 	}
 }
